 ...
 * @return           Unique Token
 */
var TokenFactory = function (ownerIndex, id) { return ({
    token: ownerIndex + "-" + id,
...
var Eventer = /** @class */ (function () {
    ...
    Eventer.prototype.on = function (topic, listener, oldToken) {
        ...
        var token = oldToken || TokenFactory(this.id, (this.lastEventIndex += 1));
        if (listeners)
    ...
    Eventer.prototype.emit = function (topic) {
        ...
        if (listeners) {
            ...
            var listenersCopy = Array.from(listeners.values());
            // call event handlers.
            var returnValues = listenersCopy.map(function (listener) { return listener.apply(void 0, __spread(args)); });
            return returnValues;
        }
        return [];
    };
...
export { EventError, Eventer, TokenFactory };
