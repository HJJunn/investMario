 ...
 */
export declare type Listener<T = unknown> = (...args: unknown[]) => T;
/**
 ...
 * @return           Unique Token
 */
export declare const TokenFactory: (ownerIndex: number, id: number) => Token;
/**
...
export declare class Eventer {
     ...
     * @param topic Topic name
     */
    listeners(topic: string): Map<Token, Listener<unknown>>;
}
